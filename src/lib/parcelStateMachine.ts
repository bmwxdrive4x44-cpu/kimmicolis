...
const dbToCanonical: Record<string, CanonicalParcelState | 'DELIVERED'> = {
  ...
  // Legacy aliases pour DEPOSITED_RELAY (statuts écrits avant normalisation)
  RECU_RELAIS: 'DEPOSITED_RELAY',
  WAITING_PICKUP: 'DEPOSITED_RELAY',
  ASSIGNED: 'DEPOSITED_RELAY',
  PICKED_UP: 'PICKED_UP',
